...
<tr class="<?php echo isset( $row ) ? $row : ''; ?>">
	<td class="field_label"><input type="text" class="input_text" placeholder="<?php _e( 'Field Label', 'woocommerce-box-office' ); ?>" name="_ticket_field_labels[]" value="<?php echo esc_attr( $field['label'] ); ?>" required="required" /></td>
	...
	<td class="field_options">
		...
		<textarea style="<?php echo $options_style; ?>" placeholder="<?php _e( 'Comma-separated list of available options', 'woocommerce-box-office' ); ?>" name="_ticket_field_options[]"><?php echo esc_html( $field['options'] ); ?></textarea>
		<div class="email-options" style="<?php echo $email_style; ?>">
			<span class="tips" data-tip="<?php _e( 'Use this email address to contact the ticket holder.', 'woocommerce-box-office' ); ?>">
			...
			<span class="tips" data-tip="<?php _e( 'Use this email address for the ticket holder\'s gravatar.', 'woocommerce-box-office' ); ?>">
	...
	<td class="field_required" width="1%"><select name="_ticket_field_required[]"><option value="yes" <?php selected( $field['required'], 'yes', true ); ?>><?php _e( 'Yes', 'woocommerce-box-office' ); ?></option><option value="no" <?php selected( $field['required'], 'no', true ); ?>><?php _e( 'No', 'woocommerce-box-office' ); ?></option></select></td>
	<td width="1%"><a href="#" class="delete"><?php _e( 'Delete', 'woocommerce-box-office' ); ?></a></td>
</tr>
